/**
 * Zod validation schemas for comic metadata
 */
...
/**
 * File validation for uploads (client-side)
 */
...
/**
 * Upload files array schema (1-20 files)
 */
export const uploadFilesArraySchema = z
