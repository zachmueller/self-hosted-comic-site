...
- [ ] Project structure created: `src/components/`, `src/pages/`, `src/utils/`, `src/types/`
...
- [ ] Build output configured for S3 deployment
- [ ] Index.html fallback routing configured for SPA
...
**Acceptance Criteria:**
- [ ] Existing infrastructure preserved (S3, DynamoDB, Cognito, CloudFront)
- [ ] Old Lambda function code removed from CDK
- [ ] Vite build integration added to CDK deployment
- [ ] CloudFront configured for SPA routing (404 → index.html)
- [ ] S3 bucket deployment configuration for React build artifacts

### ENV-005 [P]: Development Environment Documentation
...
**Acceptance Criteria:**
- [ ] README updated with React + Vite setup steps
- [ ] Environment variables documented in .env.example
- [ ] Local development workflow explained (mock auth, API mocking)
- [ ] Deployment process documented (cdk deploy command)
